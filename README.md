...
3. Install Azure CLI on your machine, if you do not already have it. [Install Link](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli-windows?tabs=azure-cli)
